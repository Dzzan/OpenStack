...
NOVA_FOR_COMPUTE_SCRIPT="/root/OpenStack/compute/1.nova/nova_for_compute.sh"
DASHBOARD_SCRIPT="/root/OpenStack/compute/2.dashboard/dashboard.sh"
NEUTRON_FOR_COMPUTE_SCRIPT="/root/OpenStack/compute/3.neutron/neutron_for_compute.sh"
